...
with open("Cars.csv","w",encoding="utf8", newline="")as file:
    Writer = writer(file)
    header = ["Car_Name","Price","Fuel_Type","Mileage","Seating_Capacity","Safety_Rating","Warranty","Engine_Size","Transmission","Size","Fuel_Tank"]
    ...
    for brand_name in a:
        ...
        for model_name in x:
            ...
            if cars != None :
                ...
                Info =[Car_Name,Price,Fuel_Type,Mileage,Seating_Capacity,Safety_Rating,Warranty,Engine_Size,Transmission,Size,Fuel_Tank]
